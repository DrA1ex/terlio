...
export { SUPPORTED_SYNTAX_LANGUAGES, SYNTAX_TOKEN_TYPES, detectSyntaxLanguage, normalizeSyntaxLanguage, tokenizeSyntax, highlightSyntax, highlightSyntaxLines, styleSyntaxToken } from './syntaxHighlight.js';
