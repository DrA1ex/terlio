...
const groups = [
  ...
  ['Product-grade examples', [
    ...
    ['npm run example:editor', 'Editor Lab workspace: live draft buffer, history, diagnostics and command/footer shell.'],
    ['npm run example:palette', 'Command Palette workspace: grouped actions, detail rail, accepted log and responsive shell.'],
    ['npm run example:stream', 'Streaming Workbench workspace: prompt queue, transcript, control rail, progress and cancellation.'],
    ['npm run example:kit', 'Interaction Kit workspace: palette-driven toasts, modals, confirmations and mode stack.'],
