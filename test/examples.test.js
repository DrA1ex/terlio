...
test('streaming workbench keeps arrows local and uses explicit sample shortcuts', async () => {
  const { handleStreamingWorkbenchKey } = await import('../examples/streaming-workbench.js');
  const state = createStreamingWorkbenchState();
  state.activeTab = 'transcript';
